...
class pohonKeluarga{
    ...
    public void printPohon(){printPohon(root, 0);}
...
class Solution {
    public static void main(String[] args){
        ...
        p.orangTua("Ucok", "Dea");
        p.orangTua("Ucok", "Mala");
        p.orangTua("Bolang", "Surya");
        p.orangTua("Bolang", "Melati");
        p.orangTua("Dea", "Laksmana");
        p.orangTua("Cika", "Mawar");
